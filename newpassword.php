...
<body class="bg-gray-900 text-white flex flex-col justify-center items-center min-h-screen">
  ...
  <div class="bg-gray-800 p-6 rounded-lg shadow-md w-80">
    <p class="text-center text-sm mb-4">Provide New Password</p>
    ...
    <form>
      ...
      <div class="mb-4 max-w-xs text-center"> 
        <button 
        type="submit" >
        <a href="first.php" class="px-10 py-2 mt-8 w-40 bg-blue-500 justify-center hover:bg-blue-600 text-white py-2 rounded-full font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ">Save</a>
      </button>
    </form>
...
</div><footer class="absolute bottom-4 text-gray-400 text-sm">a product by Softcore</footer>
</html>